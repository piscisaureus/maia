...
Raphael.fn.connection = function (obj1, obj2, style) {
    ...
    var edge = {/*
        ...
        draw : function() {
            ...
            /* setting label */
            style && (style.label || style.placeholder)
                && (edge.label && edge.label.attr({x:(x1+x4)/2, y:(y1+y4)/2}) 
                    || (edge.label = selfRef.text((x1+x4)/2, (y1+y4)/2, style.label || style.placeholder).attr({fill: "#000", "font-size": style["font-size"] || "12px"})));
            ...
            (this.scissors1 || (this.scissors1 = selfRef.text(pos1.x, pos1.y, "\u2702"))).attr({fill: "#f00", "font-size": "24px", 'opacity': 0});
            (this.scissors2 || (this.scissors2 = selfRef.text(pos2.x, pos2.y, "\u2702"))).attr({fill: "#f00", "font-size": "24px", 'opacity': 0});
        },
